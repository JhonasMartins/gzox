...
class NovaAplicacaoWidget extends StatefulWidget {
  const NovaAplicacaoWidget({
    Key? key,
    this.placa,
    this.whatsapp,
    this.email,
  ...
  @override
  _NovaAplicacaoWidgetState createState() => _NovaAplicacaoWidgetState();
}

class _NovaAplicacaoWidgetState extends State<NovaAplicacaoWidget> {
